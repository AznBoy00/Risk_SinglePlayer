...
void PassiveStrategy::attackDo(Country* atkFrom, Country* atkTarget, Map* map, vector<Player*> playerVector) {
	srand(time(0));
...
Player* PassiveStrategy::findTarget(vector<Player*> playerVector, Country* atkTarget) {
